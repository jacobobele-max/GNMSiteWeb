...
const dict: Dict = {
  ...
  "hero.title.1": { fr: "Des espaces impeccables, une équipe d'experts", en: "Impeccable spaces, an expert team" },
  "hero.sub.1": { fr: "Nettoyage de bureaux, résidences et chantiers au Gabon, avec rigueur et discrétion.", en: "Office, residential and site cleaning in Gabon, with rigor and discretion." },
  ...
  "hero.sub.2": { fr: "Nous utilisons des solutions certifiées biologiques pour protéger votre santé et l'environnement.", en: "We use certified organic solutions to protect your health and the environment." },
  "hero.eyebrow.3": { fr: "Multiservices", en: "Multiservices" },
  "hero.title.3": { fr: "Bien plus que du nettoyage", en: "Much more than cleaning" },
  "hero.sub.3": { fr: "Jardinage, désinfection, dératisation, manutention — une seule équipe, toutes les solutions.", en: "Gardening, disinfection, pest control, logistics — one team, every solution." },
  ...
  "services.subtitle": { fr: "Une équipe polyvalente, des prestations soignées et un seul interlocuteur pour tous vos services.", en: "A versatile team, careful service, and a single point of contact for everything." },
  ...
  "gallery.subtitle": { fr: "Quelques aperçus du travail réalisé par nos équipes sur le terrain.", en: "A glimpse of the work delivered by our teams in the field." },

  // Testimonials
  "test.eyebrow": { fr: "Témoignages", en: "Testimonials" },
  "test.title": { fr: "Ils nous font confiance, ils en parlent", en: "They trust us, they talk about it" },
  ...
  "svc.page.subtitle": { fr: "Une gamme complète pour répondre à tous vos besoins de propreté.", en: "A complete range to meet all your cleanliness needs." },
  ...
  "svc.mega.headline": { fr: "Propreté, Hygiène et Qualité au service de vos espaces", en: "Cleanliness, Hygiene and Quality for your spaces" },
  ...
  "svc.noResults": { fr: "Aucun service ne correspond à votre recherche.", en: "No service matches your search." },
